...
<div class="card">
  ...
  <div id="collapseSemestre1" class="collapse show" role="tabpanel" aria-labelledby="headingSemestre1"
    ...
    <div class="card-body">
    <table id="tableMatiereS1" class="table table-striped table-bordered table-hover table-responsive" style="width:100%">
          <thead>
             <tr>
                <th>Nom Matière</th>
...
<div class="card">
  ...
  <div id="collapseSemestre2" class="collapse" role="tabpanel" aria-labelledby="headingSemestre2"
    data-parent="#accordionSemestre">
    <div class="card-body">
    <table id="tableMatiereS2" class="table table-striped table-bordered table-hover table-responsive" style="width:100%">
          <thead>
             <tr>
                <th>Nom Matière</th>
                <th>Nombre d'heures</th>
